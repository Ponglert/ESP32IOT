...
// ---------------- ตั้งค่า ----------------
const char* ssid          = "CSUBRUIOT";
const char* password      = "asdf+1234";

const char* mqtt_server   = "broker.netpie.io";
const int   mqtt_port     = 1883;
const char* mqtt_Client   = "03182886-d7eb-4222-ae06-962057ac9de1"; // Client ID
const char* mqtt_username = "kFN77CFz4gNNxmYmjB4EjnoMxtbpj1x2";     // Token
const char* mqtt_password = "BR7JsjHR61ghFs7vgBjWJZgKD1Enunrg";     // Secret
...
void publishRelayState() {
  publishShadow("{\"data\":{\"relay1\":" + String(relay1) + ",\"relay2\":" + String(relay2) + "}}");
}
